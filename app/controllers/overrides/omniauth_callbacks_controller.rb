...
class Overrides::OmniauthCallbacksController < DeviseTokenAuth::OmniauthCallbacksController
  ...
  def redirect_callbacks
    ...
    def assign_provider_attrs(user, auth_hash)
      attrs = auth_hash['info'].permit!.to_hash
    ...
    def resource_class(mapping = nil)
      params["omniauth"] = JSON.parse params['user']
      if omniauth_params['resource_class']
        omniauth_params['resource_class'].constantize
      elsif params["omniauth"]['resource_class']

        params["omniauth"]['resource_class'].constantize
      else
